...
<head>
	...
	<title>KinKindlesint | Terms of service</title>
	<meta property="og:title" content="KinKindlesint | Terms of service" />
	<meta property="og:image" content="site-logo.svg" /> 
	<meta property="og:description" content="KinKindlesint | Terms of service">
	<meta name="description" content="KinKindlesint | Terms of service"> 
...
<section class="bg-privacy-page">
    ...
    <div class="content-block" style="overflow: hidden; word-break: break-all;">
        <h2 class="stilTitl">KinKindlesint | Terms of service</h2>
        <div style="padding: 16px"><h3>AGREEMENT TO OUR LEGAL TERMS</h3>
...
<p>You can contact us by email at kinkindlesint-help@gmail.com or by mail to  21 Lindom Avenue DH3 3PP Chester-le-Street United Kingdom.</p>
...
<p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by kinkindlesint-help@gmail.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
...
<p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: kinkindlesint-help@gmail.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
...
<p>We care about data privacy and security. Please review our <a target="_blank" href="privacy.php">Privacy Policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United Kingdom. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United Kingdom, then through your continued use of the Services, you are transferring your data to the United Kingdom, and you expressly consent to have your data transferred to and processed in the United Kingdom.</p>
